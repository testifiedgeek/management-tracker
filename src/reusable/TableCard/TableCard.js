...
export default class TableCard extends Component {
    ...
    renderViewTask = () => {
        if(this.props.task==="true"){
            return(
                <td className="table_heading" onClick={this.handleViewtask}>View Task</td>
        );
        }
        ...
        <table className="user_container">
           ...
           <tr className="table_row" id="heading">
                ...
                {TableHeading.map((head, key) => {
                    return (
                        <th key={key} className="table_heading">{head}</th>
                    );
                })}
            </tr>
                    ...
                    return(
                        <tr className="table_row" key={key}>
                           ...
                           {TableRow.map((newVal,id) => {
                               if(newVal==="name") {
                                   return(
                                      <td key={id} className="table_heading"> <GenarateName name={val[newVal]}/></td>
                                   );
                               } else {
                                   return(
                                   <td key={id} className="table_heading">{val[newVal]}</td>                                   
                               );
                               }
