    ...
    render() {
        ...
        return (
            <React.Fragment >
                ...
                <td><button onClick={this.handleEditing}>:</button></td>
                <div>{this.state.seen ? 
                ...
                <br />
                <input id="title"  type="text" value={this.props.todo.value} onChange={e=>{
                ...
                <br />
                <input type="textarea" id="details" value={this.props.todo.details} onChange={e=>{
                    this.props.setUpdateDetail(e.target.value, this.props.todo.id)
                }}
                    onKeyDown={this.handleUpdatedDone}
                />
                </div>
